...
1. 使用含有两个必需Sheet的Excel生成F01—F07、A01—A03、T01—T04。
2. 下载一张PNG、一份XLSX和完整ZIP，检查文件能正常打开。
3. 上传一份同名但数值已修改的Excel，确认页面内容指纹和结果随之变化。
4. 用两个无痕浏览器窗口分别上传不同Excel，确认文件名、指标和下载结果彼此独立。
5. 点击“清除本次会话数据”，确认页面回到上传状态。
