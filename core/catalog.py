...
CHARTS = {
 ...
 'F05': ('代表性国家ASK/RPK指数', 'F05_代表性国家ASK_RPK指数走势', '国家动态分析', 'base_year、ASK_index、RPK_index', '各国首次ASK与RPK同时为正的年份为共同基期；指数=当前值/各自基期值×100。各国基期可不同；缺失不插值，非正值不计算指数。'),
...
MODULES = ['数据概览','ASK–RPK供需关系','国家动态分析','单国分析','多国对比','ASK方向结构','疫情扩展分析','统计表','数据与方法说明']
